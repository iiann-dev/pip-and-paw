  ...
  return (
    <section ref={ref} className="relative z-0" style={{ height: '200vh' }}>
      <div className="sticky top-0 z-10 flex h-screen flex-col overflow-hidden bg-[#003C08] text-white lg:flex-row">
        ...
        {/* Visual — full retriever, desktop only (hidden on tablet & phone) */}
        <div className="relative hidden h-64 shrink-0 overflow-hidden sm:h-80 lg:block lg:h-full lg:flex-1">
          <img

    ...
    <section className="px-5 pb-20 pt-24 sm:px-8 lg:px-12 lg:pt-28">
      <div className="mx-auto max-w-7xl">
        <div className="max-w-2xl">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-accent">Shop</p>
          <h1 className="mt-3 font-serif-display text-4xl tracking-tight text-forest sm:text-5xl lg:text-6xl">
            {active === 'all' ? 'Everything your pets love' : CATEGORY_LABELS[active]}
          </h1>
          <p className="mt-4 text-[15px] leading-relaxed text-forest/60">
